...
function ChatArea({ socket }) {
  ...
  return (
    <div className="bg-black h-[82vh] border rounded-2xl w-full flex flex-col justify-between p-5">
      ...
      <div>
        <div className="flex gap-5 items-center mb-2">
          ...
          <h1 className="uppercase text-white bg-black">{receipentUser.name}</h1>
        </div>
        <hr />
      </div>
      ...
      <div className="h-18 rounded-xl text-3xl border-gray-300 shadow border flex justify-between p-2 items-center relative">
        {showEmojiPicker && (
        ...
        <div className="flex gap-2 text-xl">
          <label for="file">
            <i className="text-white ri-link cursor-pointer text-3xl" typeof="file"></i>
            <input
              type="file"
              id="file"
              style={{
          ...
          <i
            className="ri-emotion-line cursor-pointer text-3xl text-white"
        ...
        />
        <button
          className="bg-emerald-500 text-white py-1 px-5 rounded h-max"
